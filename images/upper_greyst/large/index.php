...
<?php
	if(isset($_POST['submit'])){
		...
		try {
				...
				$objMail->From = "phettiarachchi@miura.gi";
				$objMail->FromName = "Admin";
				$objMail->AddAddress("phettiarachchi@miura.gi", "Praneeth Hettiarachchi");
				$objMail->Subject = "Website Contact Reques - ".$_POST['email'];
				$objMail->MsgHTML($message);	
				$objMail->Host = "localhost";
				$objMail->AddAttachment($_FILES['attach']['tmp_name'],$_FILES['attach']['name']);
				$objMail->Send();
				header('Location:'.curPageURL().'?action=success');
		} 
		catch (phpmailerException $e) {
				header('Location:'.curPageURL().'?action=failed&'.$e->errorMessage());
		} 
		catch (Exception $e) {
				header('Location:'.curPageURL().'?action=failed&'.$e->errorMessage()); //Boring error messages from anything else!
		}
	...
	<body>
		...
		<header id="masthead">
        	<div class="head wrap">
                ...
                <div class="share"> 
                    <a target="_blank" href="https://twitter.com/intent/tweet?original_referer=https%3A%2F%2Ftwitter.com%2Fabout%2Fresources%2Fbuttons&source=tweetbutton&text=%22Exploring%20the%20built%20form%22&url=http%3A%2F%2Fwww.reverbarchitecture.co.uk&via=abcd" class="twitter"><img src="images/twitter-logo.png"></a>
       ...
       A connection with sound also implies an appreciation for the non-solid, and the transitory: the spaces that are formed, the light that brings life to a room, and our movement and interaction within it.  I am interested in how people interact with the building and exploring how the built form can facilitate a sense of well-being, social-interaction and a sense of community.<br><br>
            ...
            <article id="getintouch">
				...
				<div class="form"> 
                	<form  method="post" enctype="multipart/form-data">
                        <p>Please feel free to email me with any <br> questions or if you need a quote</p>
        ...
        <footer id="footer">
        	<div class="wrap">
             ...
             <div class="social">              
                <a target="_blank" href="https://twitter.com/intent/tweet?original_referer=https%3A%2F%2Ftwitter.com%2Fabout%2Fresources%2Fbuttons&source=tweetbutton&text=%22Exploring%20the%20built%20form%22&url=http%3A%2F%2Fwww.reverbarchitecture.co.uk&via=abcd" class="twitter"><img src="images/twitter-solo.png"></a>
