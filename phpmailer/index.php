...
if(isset($_POST['submit'])){
		...
		try {
				...
				$objMail->From = "info@reverbarchitecture.co.uk";
				$objMail->FromName = "Admin";
				$objMail->AddAddress("timfrancey@reverbarchitecture.co.uk", "Tim Francey");
				...
				$objMail->Send();
				header('Location:http://reverbarchitecture.co.uk/?action=success');
		}
...
<!--
body {
	background-image: url(images/reverb_bg.png);
